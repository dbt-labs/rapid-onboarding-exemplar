...
Put an `x` in all the items that apply (while removing the space between the brackets),
 make notes next to any that haven't beenaddressed, and remove any items that are 
